...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        .style8 { width: 527px; }
        .style9 { width: 493px; }
        .style10 { width: 133px; text-align: center; }
        .style11 { width: 332px; }
        .style14 { text-align: right; color: Red; width: 89px; }
        .style13 { width: 89px; }
        .style15 { color: #004AE6; text-align: right; width: 142px; }
    </style>
</asp:Content>
        ...
        <tr>
            <td>
                <table align="left" class="style4">
                    <tr>
                        <td class="style15">Select Standard :</td>
                        <td class="style6">
                        ...
                        <td class="style5">&nbsp;</td>
                        <td><asp:Label ID="lblstd" runat="server"></asp:Label></td>
                    </tr>
                    <tr>
                        <td class="style15">Select Division :</td>
                        <td class="style6">
                    ...
                    <tr>
                        <td class="style15">Select Student :</td>
                        <td class="style6">
                        ...
                        <td valign="bottom"><asp:Label ID="lblcnt" runat="server"></asp:Label></td>
                    </tr>
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table align="center" class="style8">
                        ...
                        <td>
                            <asp:MultiView ID="MultiView1" runat="server">
                                <asp:View ID="View1" runat="server">
                                    <table id="studentTable" class="tbl">
                                        <tr>
                                            <td class="tblhead">
                                                Student Name : <asp:Label ID="lblname" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr><td>&nbsp;</td></tr>
                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3" valign="top">
                                                            <table class="style11">
                                                                ...
                                                                <tr>
                                                                    <td class="style14">Mobile :</td>
                                                                    <td><asp:Label ID="lblmobile" runat="server"></asp:Label></td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="style14">BirthDate :</td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnPrint" runat="server" Text="Print" OnClientClick="printTable(); return false;" CssClass="btn" />
                        </td>
                    </tr>
                </table>
                ...
                <script type="text/javascript">
                    function printTable() {
                        ...
                        newWin.document.write('<style>table {border-collapse: collapse;} table, th, td {border: 1px solid black; padding: 5px;} </style>');
